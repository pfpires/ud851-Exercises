...
public class ReminderUtilities {
    ...
    private final static int REMINFER_INTERVAL_MINUTES = 1;
    private final static int REMINFER_INTERVAL_SECONDS = 15;//REMINFER_INTERVAL_MINUTES * 60;
    private final static int SYNC_FLEXTIME_SECONDS = REMINFER_INTERVAL_SECONDS;
