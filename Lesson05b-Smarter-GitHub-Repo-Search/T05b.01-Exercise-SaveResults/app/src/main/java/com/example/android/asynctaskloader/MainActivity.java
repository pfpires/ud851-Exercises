...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String BUNDLEKEY_URL = "UrlBundleKey";

    // TODO (2) Create a static final key to store the search's raw JSON
    private static final String BUNDLEKEY_JSON = "JsonBundleKey";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(BUNDLEKEY_URL)) {
                mUrlDisplayTextView.setText(savedInstanceState.getString(BUNDLEKEY_URL));
            }
            if (savedInstanceState.containsKey(BUNDLEKEY_JSON)) {
                mSearchResultsTextView.setText(savedInstanceState.getString(BUNDLEKEY_JSON));
            }
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(BUNDLEKEY_URL,mUrlDisplayTextView.getText().toString());
        ...
        outState.putString(BUNDLEKEY_JSON,mSearchResultsTextView.getText().toString());
    }
